...
NAME = 'pyscf-qsd_geometry_optimization'
AUTHOR = 'Pablo del Mazo Sevillano'
AUTHOR_EMAIL = "delmazosevillanopablo@gmail.com"
DESCRIPTION = 'PySCF extension module qsd_geometry_optimization'
SO_EXTENSIONS = {
}
